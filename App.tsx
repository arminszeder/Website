    ...
    <div className="min-h-screen flex flex-col font-sans bg-background text-text selection:bg-cta selection:text-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-[90vh] flex flex-col justify-center">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          {/* Badge using glass utility */}
          <div className="inline-flex items-center space-x-2 glass px-4 py-2 rounded-full mb-10 shadow-glass animate-fade-in-up hover:scale-105 transition-transform duration-300 cursor-default">
            <Sparkles className="w-4 h-4 text-cta fill-current" />
            <span className="text-sm font-semibold text-secondary tracking-wide">More than just automation</span>
          </div>

          <div className="max-w-5xl mx-auto mb-10">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-primary leading-[1.1] mb-8 tracking-tight">
            ...
            <p className="text-lg md:text-2xl text-secondary mb-12 leading-relaxed max-w-3xl mx-auto font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Button
                ...
                className="!bg-cta !text-white hover:!bg-red-600 shadow-[0_10px_30px_-10px_rgba(216,57,57,0.4)] px-10 py-5 text-lg font-bold rounded-xl transition-all hover:-translate-y-1"
              >
                Get in Touch
              </Button>
              <button className="inline-flex items-center justify-center px-10 py-5 rounded-xl font-semibold transition-all duration-300 glass text-primary hover:bg-white/90 hover:shadow-lg hover:-translate-y-1 group">
                Learn more
                <ArrowRight className="w-5 h-5 ml-2 opacity-70 group-hover:text-cta transition-colors group-hover:translate-x-1" />
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
            ...
            <div className="relative group cursor-pointer">
              {/* Outer Glow */}
              <div className="absolute -inset-1 bg-gradient-to-r from-cta to-orange-400 rounded-3xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>

              <div className="relative p-8 md:py-14 rounded-2xl glass-card overflow-hidden group-hover:scale-[1.01] transition-transform duration-300">
      ...
      <section id="solutions" className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-[420px]">
            ...
            <div className="md:col-span-2 group relative overflow-visible rounded-[2.5rem] glass-card border-white/40 hover:shadow-2xl transition-all duration-500 cursor-pointer">
              {/* Background */}
            ...
            <div className="md:col-span-1 group relative overflow-visible rounded-[2.5rem] glass-card border-white/40 hover:shadow-2xl transition-all duration-500 cursor-pointer">
              {/* Background */}
              ...
              {PROCESS_STEPS.map((step, idx) => (
                <div key={idx} className="flex flex-col items-center text-center group">
                  ...
                  <div className="relative w-24 h-24 md:w-32 md:h-32 mx-auto mb-8 group-hover:-translate-y-2 transition-transform duration-300 ease-out">
                    {/* Colorful Back Glow */}
                    <div className={`absolute -inset-6 rounded-full blur-2xl opacity-20 transition-opacity duration-300 group-hover:opacity-40 ${idx === 0 ? 'bg-blue-500' : idx === 1 ? 'bg-amber-500' : 'bg-brand-red'
                      }`}></div>

                    {/* Main 3D Card Surface */}
                    <div className="relative w-full h-full glass-card rounded-[2rem] flex items-center justify-center overflow-hidden">
                      {/* Inner Gradient Background - subtle tint */}
                      <div className={`absolute inset-0 opacity-30 ${idx === 0 ? 'bg-gradient-to-br from-blue-50 to-indigo-50' :
                        idx === 1 ? 'bg-gradient-to-br from-amber-50 to-orange-50' :
                          'bg-gradient-to-br from-red-50 to-rose-50'
                        }`}></div>

                      {/* 3D Icon Container - Floating in center */}
                      <div className={`relative w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center shadow-[0_10px_20px_-5px_rgba(0,0,0,0.2)] transform transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 border border-white/20 ${idx === 0 ? 'bg-gradient-to-br from-blue-500 to-indigo-600' :
                    ...
                    <div className={`absolute -top-3 -right-3 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-[3px] border-brand-offwhite shadow-lg z-10 text-white ${idx === 0 ? 'bg-blue-600' : idx === 1 ? 'bg-amber-500' : 'bg-brand-red'
                      }`}>
                      {step.number}
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {CASE_STUDIES.map((study, idx) => (
              /* The Card */
              <div key={idx} className="glass-card rounded-[2.5rem] overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="grid lg:grid-cols-12 min-h-[500px]">
                  ...
                  <div className={`lg:col-span-7 p-8 md:p-12 ${study.imagePlaceholderColor} bg-opacity-20 relative flex flex-col justify-between`}>
                    ...
                    <div className="relative z-10 mt-8 h-64 w-full rounded-xl overflow-hidden shadow-2xl group-hover:scale-[1.02] transition-transform duration-500">
                      {idx === 0 ? (
                        <img
                        ...
                        <img
                          ...
                          alt="Gym App Dashboard"
                          className="w-full h-full object-cover object-center"
                        />
                      ) : (
                        // Fallback for potential 3rd item if it exists
                        <div className="w-full h-full bg-gray-100 flex items-center justify-center">
                          <span className="text-gray-400">Visual coming soon</span>
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="space-y-10">
                      ...
                      <div>
                        <div className="text-4xl md:text-5xl font-bold text-brand-black mb-2">
                          {idx === 0 ? '75%' : idx === 1 ? '100%' : '20hrs'}
                        </div>
                        <div className="text-gray-500 font-medium">
                          {idx === 0 ? 'Reduction in support tickets' : idx === 1 ? 'Automated Subscription Management' : 'Saved per week in admin'}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="text-4xl md:text-5xl font-bold text-brand-black mb-2">
                          {idx === 0 ? '< 1min' : idx === 1 ? '24/7' : '100%'}
                        </div>
                        <div className="text-gray-500 font-medium">
                          {idx === 0 ? 'Average response time' : idx === 1 ? 'Client Support' : 'Automated call coverage'}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="text-4xl md:text-5xl font-bold text-brand-black mb-2">
                          {idx === 0 ? '24/7' : idx === 1 ? 'Instant' : '$0'}
                        </div>
                        <div className="text-gray-500 font-medium">
                          {idx === 0 ? 'Support availability' : idx === 1 ? 'Lightningfast Database Connection' : 'Missed lead cost'}
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Fill out the form below to book your discovery call and explore how AI can elevate your business.</p>
          </div>
          <ContactForm />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Fill out the form above to schedule a free discovery call and see the impact of AI on your bottom line.
            </p>
